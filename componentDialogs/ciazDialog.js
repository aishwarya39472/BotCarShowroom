...
const CiazCard = require('../resources/adaptiveCards/ciazCard')
...
class CiazDialog extends ComponentDialog {
    ...
    async getName(step) {
        ...
        if (step.result.value === 'Booking') {
            ...
            await step.context.sendActivity("You can view car details by using this following link https://www.nexaexperience.com/ciaz");
            endDialog = true;
            return await step.endDialog();
        }
...
module.exports.CiazDialog = CiazDialog;
