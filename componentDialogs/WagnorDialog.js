...
const WagnorCard = require('../resources/adaptiveCards/wagnorCard')
...
class WagnorDialog extends ComponentDialog {
    ...
    async getName(step) {
        ...
        if (step.result.value === 'Booking') {
            ...
            await step.context.sendActivity("You can view car details by using this following link https://www.marutisuzuki.com/wagonr");
            endDialog = true;
            return await step.endDialog();
        }
...
module.exports.WagnorDialog = WagnorDialog;
