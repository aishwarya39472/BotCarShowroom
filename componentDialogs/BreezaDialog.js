...
const BreezaCard = require('../resources/adaptiveCards/breezaCard')
...
class BreezaDialog extends ComponentDialog {
    ...
    async getName(step) {
        ...
        if (step.result.value === 'Booking') {
            ...
            await step.context.sendActivity("You can view car details by using this following link https://www.zigwheels.com/newcars/Maruti-Suzuki/vitara-brezza");
            endDialog = true;
            return await step.endDialog();
        }
...
module.exports.BreezaDialog = BreezaDialog;
